...
var ortWasmSimd = (() => {
  ...
  return (
function(ortWasmSimd) {
  ortWasmSimd = ortWasmSimd || {};


var c;c||(c=typeof ortWasmSimd !== 'undefined' ? ortWasmSimd : {});var aa=Object.assign,ba,g;c.ready=new Promise(function(a,b){ba=a;g=b});var ca=aa({},c),r="./this.program",da="object"===typeof window,t="function"===typeof importScripts,ea="object"===typeof process&&"object"===typeof process.versions&&"string"===typeof process.versions.node,w="",x,y,A,fs,B,C;
...
if(c.preInit)for("function"==typeof c.preInit&&(c.preInit=[c.preInit]);0<c.preInit.length;)c.preInit.pop()();Va();
  ...
  return ortWasmSimd.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = ortWasmSimd;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return ortWasmSimd; });
else if (typeof exports === 'object')
  exports["ortWasmSimd"] = ortWasmSimd;
